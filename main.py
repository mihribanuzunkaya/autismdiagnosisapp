...
if page == "Predict":
    ...
    a18 = st.number_input("Action Net Dwell Time [ms]",format="%.2f")
    a19 = st.number_input("Action Dwell Time [ms]",format="%.2f" )
    a20 = st.number_input("Action Glance Duration [ms]",step=0.01,format="%.2f" )
    a21 = st.number_input("Action Diversion Duration [ms]",step=0.01,format="%.2f" )
    a25 = st.number_input("Action Fixation Count",step=0.01,format="%.2f" )
    a26 = st.number_input("Action Net Dwell Time [%]",step=0.01,format="%.2f" )
    a27 = st.number_input("Action Dwell Time [%]",step=0.01,format="%.2f" )
    a28 = st.number_input("Action Fixation Time [ms]",step=0.01,format="%.2f" )
    a29 = st.number_input("Action Fixation Time [%]",step=0.01,format="%.2f" )
    f16 = st.number_input("Face Entry Time [ms]",step=0.01,format="%.2f" )
    f17 = st.number_input("Face Sequence",step=0.01,format="%.2f" )
    f18 = st.number_input("Face Net Dwell Time [ms]",step=0.01,format="%.2f" )
    f19 = st.number_input("Face Dwell Time [ms]",step=0.01,format="%.2f" )
    f20 = st.number_input("Face Glance Duration [ms]",step=0.01,format="%.2f" )
    f21 = st.number_input("Face Diversion Duration [ms]",step=0.01,format="%.2f" )
    f22 = st.number_input("Face First Fixation Duration [ms]",step=0.01,format="%.2f" )
    f23 = st.number_input("Face Glances Count",step=0.01,format="%.2f" )
    f24 = st.number_input("Face Revisits",step=0.01,format="%.2f" )
    f25 = st.number_input("Face Fixation Count",step=0.01,format="%.2f" )
    f26 = st.number_input("Face Net Dwell Time [%]",step=0.01,format="%.2f" )
    f27 = st.number_input("Face Dwell Time [%]",step=0.01,format="%.2f" )
    f28 = st.number_input("Face Fixation Time [ms][ms]",step=0.01,format="%.2f" )
    f29 = st.number_input("Face Fixation Time [%]",step=0.01,format="%.2f" )
    f30 = st.number_input("Average Fixation Duration [ms]",step=0.01,format="%.2f" )
    ...
    a18 = st.sidebar.number_input("Action Net Dwell Time [ms]",step=0.01,format="%.2f")
    a19 = st.sidebar.number_input("Action Dwell Time [ms]",step=0.01,format="%.2f" )
    a20 = st.sidebar.number_input("Action Glance Duration [ms]",step=0.01,format="%.2f" )
    a21 = st.sidebar.number_input("Action Diversion Duration [ms]",step=0.01,format="%.2f" )
    a25 = st.sidebar.number_input("Action Fixation Count",step=0.01,format="%.2f" )
    a26 = st.sidebar.number_input("Action Net Dwell Time [%]",step=0.01,format="%.2f" )
    a27 = st.sidebar.number_input("Action Dwell Time [%]",step=0.01,format="%.2f" )
    a28 = st.sidebar.number_input("Action Fixation Time [ms]",step=0.01,format="%.2f" )
    a29 = st.sidebar.number_input("Action Fixation Time [%]",step=0.01,format="%.2f" )
    f16 = st.sidebar.number_input("Face Entry Time [ms]",step=0.01,format="%.2f" )
    f17 = st.sidebar.number_input("Face Sequence",step=0.01,format="%.2f" )
    f18 = st.sidebar.number_input("Face Net Dwell Time [ms]",step=0.01,format="%.2f" )
    f19 = st.sidebar.number_input("Face Dwell Time [ms]",step=0.01,format="%.2f" )
    f20 = st.sidebar.number_input("Face Glance Duration [ms]",step=0.01,format="%.2f" )
    f21 = st.sidebar.number_input("Face Diversion Duration [ms]",step=0.01,format="%.2f" )
    f22 = st.sidebar.number_input("Face First Fixation Duration [ms]",step=0.01,format="%.2f" )
    f23 = st.sidebar.number_input("Face Glances Count",step=0.01,format="%.2f" )
    f24 = st.sidebar.number_input("Face Revisits",step=0.01,format="%.2f" )
    f25 = st.sidebar.number_input("Face Fixation Count",step=0.01,format="%.2f" )
    f26 = st.sidebar.number_input("Face Net Dwell Time [%]",step=0.01,format="%.2f" )
    f27 = st.sidebar.number_input("Face Dwell Time [%]",step=0.01,format="%.2f" )
    f28 = st.sidebar.number_input("Face Fixation Time [ms][ms]",step=0.01,format="%.2f" )
    f29 = st.sidebar.number_input("Face Fixation Time [%]",step=0.01,format="%.2f" )
    f30 = st.sidebar.number_input("Average Fixation Duration [ms]",step=0.01,format="%.2f" )
